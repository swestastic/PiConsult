...
pwm_output = PWMOutput(pwm_pin=12)
...
while READ_THREAD == True:
    ...
    pwm_output.set_duty_cycle(round(R.TPS_Value/4.5*100,3)) # when TPS is 4.5V, duty cycle is 100%
    ...
    # PeakButton.when_pressed = Show_Peak # NOTE Sleep function in this is broken
    if PeakButton.is_pressed:
        Show_Peak() # NOTE This function contains a 1.5s sleep, should work hopefully
